...
mkdir -p /mnt/admin-ap/home/sfloess /mnt/admin-ap/etc /mnt/admin-ap/flossware /mnt/admin-ap/backups /mnt/admin-ap/media /mnt/admin-ap/nas /mnt/admin-ap/shared /mnt/admin-ap/root
